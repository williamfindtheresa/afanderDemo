...
//  yuyou
//
//  Created by GrayLocus on 16/10/11.
//  Copyright © 2016年 Zhang Xiu Inc. All rights reserved.
//

#import <Foundation/Foundation.h>
#import "ZXSegmentControl.h"

@interface ZXSegmentControl ()<ZXSegmentControlDelegate>
...
- (instancetype)initWithFrame:(CGRect)frame {
    if (self = [super initWithFrame:frame]) {
        ...
        self.backgroundColor = [UIColor whiteColor];//APPCOLOR;
    }
    return self;
}
...
- (void)selectTheSegment:(NSInteger)segment {
    if ( self.selectSegment != segment) {
        ...
        [UIView animateWithDuration:0.1 animations:^{
            self.buttonDown.centerX = button.centerX;
        }];
