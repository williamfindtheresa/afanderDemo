...
@interface WwMessageBar () <UITextFieldDelegate>
...
@property (nonatomic, strong) WwHotWordsView *hotWordView;

@property (nonatomic, strong) WwUserModel * beChatedUser; /**< 被@ 的人*/

@end

@implementation WwMessageBar
...
- (void)clickHot {
    ...
    if (!self.hotWordView) {
        self.hotWordView = [[WwHotWordsView alloc] initWithFrame:hotFrame];
